...
\begin {document}
\newcommand {\onlymultitex }[1]{\csname FE@ifstar\endcsname {#1}{\csname only@multitex\endcsname }{\csname only@multitex\endcsname }}\expandafter \newcommand \csname only@multitex\endcsname [2]{\renewcommand *{\do }[1]{\ifstrequal {##1}{curriculum-vitae-mathematics}{#2\listbreak }{}}{\edef \foo {#1}\expandafter }\expandafter \docsvlist \expandafter {\foo }} \expandafter \let \csname only@other@multitex\expandafter \endcsname \csname only@multitex\endcsname 
\resume 
